"""Ingest every PDF under app/data/ into the vector store.

Usage:  python -m app.scripts.ingest [optional/pdf/dir]
"""
...
def main() -> None:
    ...
    if not reports:
        print("No PDFs or TXT files ingested. Place files in app/data/ or run "
              "python -m app.scripts.load_sample_corpus for a sample demo.")
        return
